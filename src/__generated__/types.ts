...
/** A check run. */
export type ICheckRun = INode &
  IUniformResourceLocatable &
  IRequirableByPullRequest & {
...
export type IConvertToDraftEvent = INode &
  IUniformResourceLocatable & {
    /** Identifies the actor who performed the event. */
    actor: Maybe<IActor>;
    /** Identifies the date and time when the object was created. */
...
export type IPullRequestTimelineItems =
  | IAddedToProjectEvent
  | IAssignedEvent
  | IAutoMergeDisabledEvent
  | IAutoMergeEnabledEvent
  | IAutoRebaseEnabledEvent
  | IAutoSquashEnabledEvent
